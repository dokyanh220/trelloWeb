...
function Column({ column, createNewCard, deleteColumnDetails }) {
  ...
  const handleDeleteColumn = () => {
    confirmDeleteColumn({
      title: 'You wanna delete this Column?',
      content: 'This action will permanently delete your Column and its Cards! Sure to execute!',
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            >
              <MenuItem
                sx={{ '&:hover': { color: 'info.light', '& .addCardIcon': { color: 'info.light' } } }}
              ...
              <MenuItem
                ...
                sx={{ '&:hover': { color: 'error.light', '& .deleteIcon': { color: 'error.light' } } }}
              >
                <ListItemIcon>
                  <DeleteForeverIcon className='deleteIcon' fontSize="small" />
                </ListItemIcon>
