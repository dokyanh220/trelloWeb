...
import { createBoardDetailsAPI } from '~/apis'
...
function SidebarCreateBoardModal({ afterCreateNewBoard }) {
  ...
  const submitCreateNewBoard = (data) => {
    ...
    createBoardDetailsAPI(data).then(() => {
      handleCloseModal()
      afterCreateNewBoard()
    })
  }

  // <>...</> React Fragment, dùng để bọc các phần tử lại mà không cần chỉ định DOM Node cụ thể nào cả.
  return (
    <>
