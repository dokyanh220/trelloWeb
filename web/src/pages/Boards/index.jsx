...
import { fecthBoardsAPI } from '~/apis'
import { DEFAULT_ITEMS_PER_PAGE, DEFAULT_PAGE } from '~/utils/constanst'
...
function Boards() {
  ...
  const afterCreateNewBoard = () => {
    fecthBoardsAPI(location.search).then(updateState)
  }
                ...
                {boards.map(b =>
                  <Grid xs={2} sm={3} md={4} key={b._id}>
                    <Card sx={{ width: '250px' }}>
                      ...
                      <CardMedia component="img" height="100" image="src/assets/boardcover.jpg" />
